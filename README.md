...
<h1>Misc.</h1>
I recommend the <a href="https://github.com/mattinclude/macOS/tree/master/configs">Hybrid</a> vim color theme. The command line visualizer I am utilizing is <a href="https://github.com/karlstav/cava">cava</a>. You can also use <a href="https://github.com/dpayne/cli-visualizer">cli-visualizer</a>. I run the sofware over a mosh (persistant ssh) session to a Linux VM or instance.   
