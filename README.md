...
<a href="https://github.com/mattinclude/appleseed"> appleseed v1.0.0</a>
        ...
        Is a command line widget (CLW), I designed for macOS and iTerm2. It's a flexible 
        platform for process automation and eye candy. It utilizes >imgcat to view image 
        files with the help of shell integration. For best results, launch in a tall by 
        thin proportioned shell.
